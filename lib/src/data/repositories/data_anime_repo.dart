...
abstract class IAnimeRepository {
  ...
  Future<Map<String, dynamic>> getPictureByRandom(bool isNsfw, bool isGif);
  Future<Map<String, dynamic>> getRandomPicturesWithAmount(
      {bool isNsfw = true, bool isGif = false, required int amount});
  ...
  Future<Map<String, dynamic>> getCategoryAndInfo() async {
    ...
    try {
      final response = await _client.get(
        Uri.parse('$baseUrl/tags').replace(
